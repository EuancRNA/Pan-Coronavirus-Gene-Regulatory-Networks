...
by_time.37827 <- ReadInForGraph("GSE37827") # SARS CALU3 DATASET
by_time.56677 <- ReadInForGraph("GSE56677") # MERS CALU3 DATASET
...
write_graph(gse37827.g[[1]], "test.graph.save", format = c("edgelist"))
